var counter = {
  ...
  describe("mock and spy", function () {
    ...
    it("spying", function () {
     spyOn(counter,"currentValues").and.callFake(function(){
       return 100
     })
    ...
    it("mocking", function () {
        var theFunct= jasmine.createSpy();
        theFunct.and.callFake(function(input){
          return Number(input)
        })
        theFunct()
        theFunct()
        expect(theFunct).toHaveBeenCalledTimes(2)
    });
  });
